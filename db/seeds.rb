...
when "production"
  ...
  cities_array = [{name: "Paris", zip_code: 75000}, {name: "Lyon", zip_code: 69000}, {name: "Marseille", zip_code: 13000}, {name: "Bordeaux", zip_code: 33000}]
  cities_array.each do |city|
    City.create!(name: city[:name], zip_code: city[:zip_code])
  end

  tags_names = ["#Cool", "#Nervous", "#Angry", "#SoHappy"]
